...
public class FXMLAnchorPaneCadastroVeiculoController implements Initializable {
    ...
    @FXML
    private TableColumn<Veiculo, BigDecimal> tableColumnVeiculoDescricao;
    @FXML
    private Label lbVeiculoId;
    @FXML
    private Label lbVeiculoPlaca;
    @FXML
    private Label lbVeiculoTipoCombustivel;
    @FXML
    private Label lbVeiculoMarca;
    @FXML
    private Label lbVeiculoModelo;
    @FXML
    private Label lbVeiculoMotorHP;
    @FXML
    ...
    public void carregarTableView() {
        tableColumnVeiculoDescricao.setCellValueFactory(new PropertyValueFactory<>("placa"));
    ...
    public boolean showFXMLAnchorPaneCadastrosVeiculoDialog(Veiculo veiculo) throws IOException {
        ...
        //Setando o veículo ao controller
