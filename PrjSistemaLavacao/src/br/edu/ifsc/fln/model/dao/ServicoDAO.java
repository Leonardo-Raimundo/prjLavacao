...
public class ServicoDAO {
    ...
    public boolean inserir(Servico servico) {
        final String sql = "INSERT INTO servico(servicoDesc, valorServico, pontos, servicoCategoria) VALUES(?,?,?,?);";
        try {
    ...
    public boolean alterar(Servico servico) {
        String sql = "UPDATE servico SET servicoDesc=?, valorServico=?, pontos=?, servicoCategoria=? WHERE "
                + "servicoId=?";
    ...
    public List<Servico> listar(Servico servico) {
        String sql = "SELECT * FROM servico WHERE servicoId= ?;";
    ...
    private Servico populateVO(ResultSet rs) throws SQLException {
        ...
        servico.setDescricao(rs.getString("servicoDesc"));
        servico.setValor(rs.getDouble("valorServico"));
        servico.setPontos(rs.getInt("pontos"));
        servico.seteCategoria(Enum.valueOf(ECategoria.class, rs.getString("servicoCategoria")));
